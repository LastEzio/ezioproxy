    ...
    if (var.get(0).m_key == "action" && var.get(0).m_value == "input") {
        ...
        if (find_command(chat, "name ")) { //ghetto solution, but too lazy to make a framework for commands.
            ...
            paket =
                ...
                "\nadd_textbox|`9/clist `#(open country list)|left|2480|"
                "\nadd_textbox|`9/country `#(Changes your country flag)|left|2480|"
                "\nadd_textbox|`9/fd `#(enable fast drop)|left|2480|"
                "\nadd_textbox|`9/ft `#(enable fast trash)|left|2480|"
                "\nadd_textbox|`9/banall `#(ban all players in your world)|left|2480|"
                "\nadd_textbox|`9/killall `#(same with kickall but it's better and no cooldown)|left|2480|"
                "\nadd_textbox|`9/pullall `#(pull all players in your world)|left|2480|"
                "\nadd_textbox|`9/wrenchset [ban/pull/kick] `#(set wrenchmode)|left|2480|"
                "\nadd_textbox|`9/wrenchmode `#(open wrenchmode)|left|2480|"
                "\nadd_quick_exit|"
                "\nend_dialog|end|Cancel|Okay|";
            variantlist_t liste{ "OnDialogRequest" };
            liste[1] = paket;
...
bool events::in::variantlist(gameupdatepacket_t* packet) {
    ...
    switch (hs::hash32(func.c_str())) {
        ...
        case fnv32("OnConsoleMessage"): {
            varlist[1] = "`4[LASTEZIO PROXY]`` " + varlist[1].get_string();
